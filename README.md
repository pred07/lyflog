...
- "What was different on days I meditated?"

**Why It's Powerful**: Instead of guessing what works, you can *search* for proof.

---

### 8. **Logbook** — *Structured Archives*
**"Track anything"**

Create custom structured logs for things that don't fit elsewhere.

**Examples**:
- **Medication Log**: Track dosage, time, side effects
- **Symptom Tracker**: Log pain levels, triggers, duration
- **Mood Journal**: Structured entries with tags
- **Project Log**: Track work sessions with outcomes

**Features**:
- **Custom Columns**: Text, numbers, checkboxes, dates, notes
- **Table View**: See all entries in a spreadsheet
- **Mobile-Optimized**: Horizontal scroll for wide tables
- **Export Ready**: All data exportable

**Philosophy**: One size doesn't fit all. Build the tracker you need.

---

### 9. **Context Zones & Isolation Mode** — *Manage Outliers*
**"Exclude the noise"**

Define special periods and optionally exclude them from analysis.

**How It Works**:
- Create a "Context Zone" for vacation, illness, travel, etc.
- Toggle "Isolation Mode" on the dashboard
- Your correlations now exclude those periods

**Why It Matters**: A week of vacation shouldn't skew your "normal" patterns. Isolation Mode lets you see your baseline without the outliers.
