...
import { findSignificantCorrelations, CorrelationResult, shouldShowCorrelation } from '@/lib/analysis/stats';
...
export default function DashboardView() {
    ...
    const patterns = useMemo(() => {
        ...
        const allCorrelations = findSignificantCorrelations(logs, allMetrics);

        // Filter correlations based on data quality thresholds (Silent Intelligence Layer)
        return allCorrelations.filter(corr =>
            shouldShowCorrelation(corr.coefficient, corr.sampleSize, logs.length)
        );
    }, [logs, user]);
